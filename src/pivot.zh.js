  ...
  callWithJQuery(function($) {
    ...
    $.pivotUtilities.locales.zh = {
      ...
      aggregators: {
        ...
        "计数在总计中的比例": tpl.fractionOf(tpl.count(), "total", frFmtPct),
        "计数在行合计中的比例": tpl.fractionOf(tpl.count(), "row", frFmtPct),
        "计数在列合计中的比例": tpl.fractionOf(tpl.count(), "col", frFmtPct)
      },
      renderers: {
        "表格": r["Table"],
